...
if [ "$n" == "3" ]; then
linkd=https://api.github.com/repos/amiralipoor20072007/X-Panel-SSH-User-Management-xpanelv36/releases/tags/xpanelv30
fi
if [ "$n" == "4" ]; then
linkd=https://api.github.com/repos/amiralipoor20072007/X-Panel-SSH-User-Management-xpanelv36/releases/tags/xpanelv29
fi
if [ "$n" == "5" ]; then
